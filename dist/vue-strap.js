	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    parse: function parse(str) {
	      ...
	      if (str !== "") var d = moment(str, this.format);else var d = moment();
	      return d.toDate();
	    },
